...
import { Dialog, Typography, TextField, Button, Box, FormHelperText } from '@mui/material'
  ...
  return (
    ...
    <Box sx={{ p: 2 }}>
      ...
      <TextField
        ...
        margin="normal"
        fullWidth
        onChange={(event) => setPassword({...password, confirmNewPassword: event.target.value})}
      />
      {error && (
